...
- **Family-head SHA16:** `bec2a8d41401e03d`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 10000
- **Load address(es):** 0x038009 (p15)
- **Execution address(es):** (unset / 0xFF)

## Files in this directory

- `body.bin` — exact slot-0 body of the family-head SHA
  (`bec2a8d41401e03d`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `bec2a8d41401e03d` | 1 | 10000 | 0x038009 (p15) | — | head |
