...
- **Family-head SHA16:** `f0047a502d0d54d9`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 501
- **Load address(es):** 0x00e0be (p4)
- **Execution address(es):** (unset / 0xFF)

## Files in this directory

- `body.bin` — exact slot-0 body of the family-head SHA
  (`f0047a502d0d54d9`). Header-decoded, so byte 0 is the first byte the
...
```
z80dasm body.bin -a -t -o 0x00e0be > body.z80.s
```
...
|---|---:|---:|---|---|---:|
| `f0047a502d0d54d9` | 1 | 501 | 0x00e0be (p4) | — | head |
