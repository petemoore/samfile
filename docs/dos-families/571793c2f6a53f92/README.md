...
- **Family-head SHA16:** `571793c2f6a53f92`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`571793c2f6a53f92`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `571793c2f6a53f92` | 1 | 10000 | 0x078009 (p31) | — | head |
