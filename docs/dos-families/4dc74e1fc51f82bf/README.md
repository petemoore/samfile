...
- **Family-head SHA16:** `4dc74e1fc51f82bf`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 8100
- **Load address(es):** 0x007530 (p2)
- **Execution address(es):** (unset / 0xFF)

## Files in this directory

- `body.bin` — exact slot-0 body of the family-head SHA
  (`4dc74e1fc51f82bf`). Header-decoded, so byte 0 is the first byte the
...
```
z80dasm body.bin -a -t -o 0x007530 > body.z80.s
```
...
|---|---:|---:|---|---|---:|
| `4dc74e1fc51f82bf` | 1 | 8100 | 0x007530 (p2) | — | head |
