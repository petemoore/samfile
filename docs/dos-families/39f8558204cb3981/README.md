...
- **Family-head SHA16:** `39f8558204cb3981`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`39f8558204cb3981`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `39f8558204cb3981` | 1 | 10000 | 0x008009 (p3) | — | head |
