...
- **Family-head SHA16:** `c3202ec6d71daf64`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 107317
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`c3202ec6d71daf64`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `c3202ec6d71daf64` | 1 | 107317 | 0x008000 (p3) | 0x000000 | head |
