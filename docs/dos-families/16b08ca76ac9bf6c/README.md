...
- **Family-head SHA16:** `16b08ca76ac9bf6c`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`16b08ca76ac9bf6c`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `16b08ca76ac9bf6c` | 1 | 9000 | 0x078009 (p31) | — | head |
