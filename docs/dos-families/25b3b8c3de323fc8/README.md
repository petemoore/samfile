...
- **Family-head SHA16:** `25b3b8c3de323fc8`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`25b3b8c3de323fc8`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `25b3b8c3de323fc8` | 1 | 32631 | 0x010000 (p5) | — | head |
