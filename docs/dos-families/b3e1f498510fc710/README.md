...
- **Family-head SHA16:** `b3e1f498510fc710`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 9792
- **Load address(es):** 0x017d00 (p6)
- **Execution address(es):** (unset / 0xFF)

## Files in this directory

- `body.bin` — exact slot-0 body of the family-head SHA
  (`b3e1f498510fc710`). Header-decoded, so byte 0 is the first byte the
...
```
z80dasm body.bin -a -t -o 0x017d00 > body.z80.s
```
...
|---|---:|---:|---|---|---:|
| `b3e1f498510fc710` | 1 | 9792 | 0x017d00 (p6) | — | head |
