...
- **Family-head SHA16:** `f450085de2d9c53a`
- **Variants in family:** 1
- **Disks in family:** 1
- **Body length(s):** 154354
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`f450085de2d9c53a`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `f450085de2d9c53a` | 1 | 154354 | 0x008000 (p3) | 0x000000 | head |
