...
- **Family-head SHA16:** `08160038384ce831`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`08160038384ce831`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `08160038384ce831` | 1 | 32631 | 0x010000 (p5) | — | head |
