...
- **Family-head SHA16:** `c76f8e68b0d0301b`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`c76f8e68b0d0301b`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `c76f8e68b0d0301b` | 2 | 15800 | 0x008009 (p3) | — | head |
