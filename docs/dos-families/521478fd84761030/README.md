...
- **Family-head SHA16:** `521478fd84761030`
...
- `body.bin` — exact slot-0 body of the family-head SHA
  (`521478fd84761030`). Header-decoded, so byte 0 is the first byte the
...
|---|---:|---:|---|---|---:|
| `521478fd84761030` | 1 | 15800 | 0x008009 (p3) | — | head |
